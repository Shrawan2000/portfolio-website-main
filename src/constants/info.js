...
export const projects = [
  {
    ...
    link: "https://sheychat-udemy-master.onrender.com/",
  },
  {
    id: "2",
    name: "Share market",
    ...
    description: [
      ...
      "Users can like, can be a seller who can sell the new item as well as old item.",
      ...
      "Profile page where users can update their avatar and display name.",
      "Here admin can approve and block user , user also can block unwanted products ",
      "here the main functionality that is multiple image uploadin"
    ],
    workedOn: ["Website"],
    technologies: [
      {
    ...
    link: "https://sheymp-udemy-master.onrender.com/",
  },
  // {
  //   id: "3",
  //   name: "Youtube Clone",
