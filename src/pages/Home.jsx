...
import { backend, frontend, other, projects } from "../constants/info";
              ...
              >
                ...
                <div className="flex sm:gap-x-3 gap-y-3 sm:gap-y-0 flex-col sm:flex-row">
                  ...
                  <button className="connectBTN px-6 py-3 rounded-[20px] border-[1px] border-[var(--white-secondary)] z-10 text-[var(--white-primary)] font-semibold tracking-[0.5px] text-[12px] hover:transform">
                    <a
                      href="https://drive.google.com/file/d/1zGqfVWufE5I-H8pA-uzkMSFr-fXcC1Nq/view"
                      target="_blanck"
                    >
                      SEE MY RESUME
                    </a>
          ...
          >
            ...
            <div className="grid gap-y-4 grid-cols-1 md:grid-cols-2 gap-x-4">
              <EducationCard
                ...
                schoolLocation="Bhopal, madhya pradesh, India"
                cardType={1}
              />
              <EducationCard
                duration="2017-2019"
                ...
                degree="Intermediate"
                course="Science (MPC)"
                schoolName="Araria College Araria"
                schoolLocation="Araria, Bihar, India"
                cardType={2}
              />
            </div>
          </section>
            ...
            <div className="flex items-center justify-center w-full mt-8">
              <button className="bg-[#feb901] transition ease duration-400 text-[#000] py-4 px-7 rounded-[30px] hover:bg-[#d39f0f]">
                <a
                  ...
                  target="_blanck"
                  href="https://github.com/shrawan2000"
                >
